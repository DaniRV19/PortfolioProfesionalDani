...
function initSkills() {
    ...
    const tools = [
        ...
        {name: 'Laravel', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQM_cfPovQBKHCZx8fTdsxTxGyAcaQ63US_jLtRgwSntA&s=10', desc: 'Framework PHP elegante y potente.'},
